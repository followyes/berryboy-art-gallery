...
expect('current release package is V14.1.8', pkg.version.includes('v14-1-8-readiness-authority'));
expect('Admin release identity is V14.1.8', admin.includes('const STAGE = "V14.1.8"'));
