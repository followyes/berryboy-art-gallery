...
// V14.4.7.2 Gallery Version rebase preservation SQL/runtime guard regression.
{
  ...
  assert.ok(packageJson.version.includes('v14-4-7-5-authenticated-storage-delete'));
  assert.ok(packageJson.description.includes('V14.4.7.5 Authenticated Shared Asset Storage Delete Corrective'));
