...
// V14.4.7.2 Gallery Version rebase preservation SQL/runtime guard regression.
{
  ...
  assert.ok(packageJson.version.includes('v14-4-7-4-prepared-storage-delete'));
  assert.ok(packageJson.description.includes('V14.4.7.4 Prepared Shared Asset Storage Delete Hotfix'));
