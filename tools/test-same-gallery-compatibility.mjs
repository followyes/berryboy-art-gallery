...
// V14.4.7.2 Gallery Version rebase preservation SQL/runtime guard regression.
{
  ...
  assert.ok(packageJson.version.includes('v14-4-7-8-mobile-debug-ui-removal'));
  assert.ok(packageJson.description.includes('V14.4.7.8 Mobile Survival Debug UI Removal'));
