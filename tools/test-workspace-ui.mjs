...
expect('current package stage', pkg.version.includes('v14-4-2-logical-shared-asset-authority'));
...
assert.equal(pkg.version, '0.14.4-v14-4-2-logical-shared-asset-authority');
