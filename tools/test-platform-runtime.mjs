...
expect('V14.3.11 package preserves C6C8C4 residency under current runtime', source.includes('Stage 12C66C6C8C4: Space Residency / Exhibition Delta Switch') && source.includes('C6C8C25: Cross-Space Runtime') && pkg.version.includes('v14-4-3-canonical-shared-asset-replace-propagation'));
...
expect('Current V14.4.2 package preserves C6C8C5 under C6C8C25', source.includes('stage: "C6C8C21"') && pkg.version.includes('v14-4-3-canonical-shared-asset-replace-propagation'));
