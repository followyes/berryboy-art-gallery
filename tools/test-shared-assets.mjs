...
expect('V14.4.3 package preserves V14.4.2 logical Shared Asset authority', pkg.version === '0.14.4-v14-4-7-2-gallery-version-rebase-preservation' && SHARED_ASSET_AUTHORITY_STAGE === 'V14.4.2');
