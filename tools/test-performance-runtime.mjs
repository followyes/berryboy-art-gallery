...
expect('current package keeps transition guard regression coverage', pkg.version.includes('v14-4-7-3-modular-frame-3-axis') && viewer.includes('const STAGE = "V14.1.10.1"') && admin.includes('const STAGE = "V14.1.10.1"'));
...
expect('package identity', pkg.version.includes('v14-4-7-3-modular-frame-3-axis'));
...
expect("package stage", pkg.version.includes("v14-4-7-3-modular-frame-3-axis"));
