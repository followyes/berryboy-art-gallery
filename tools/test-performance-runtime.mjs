...
expect('current package keeps transition guard regression coverage', pkg.version.includes('v14-2-6-canonical-draft-publish-model') && viewer.includes('const STAGE = "V14.1.10.1"') && admin.includes('const STAGE = "V14.1.10.1"'));
...
expect('package identity', pkg.version.includes('v14-2-6-canonical-draft-publish-model'));
...
expect("package stage", pkg.version.includes("v14-2-6-canonical-draft-publish-model"));
