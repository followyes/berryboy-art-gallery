...
expect('current package keeps transition guard regression coverage', pkg.version.includes('v14-4-7-1-modular-frame-rail-layout') && viewer.includes('const STAGE = "V14.1.10.1"') && admin.includes('const STAGE = "V14.1.10.1"'));
...
expect('package identity', pkg.version.includes('v14-4-7-1-modular-frame-rail-layout'));
...
expect("package stage", pkg.version.includes("v14-4-7-1-modular-frame-rail-layout"));
