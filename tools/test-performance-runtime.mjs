...
expect('current package keeps transition guard regression coverage', pkg.version.includes('v14-1-7-transition-session-ownership') && viewer.includes('const STAGE = "V14.1.7"') && admin.includes('const STAGE = "V14.1.7"'));
