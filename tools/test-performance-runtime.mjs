...
expect('current package keeps transition guard regression coverage', pkg.version.includes('v14-3-11-full-regression-docs-closure') && viewer.includes('const STAGE = "V14.1.10.1"') && admin.includes('const STAGE = "V14.1.10.1"'));
...
expect('package identity', pkg.version.includes('v14-3-11-full-regression-docs-closure'));
...
expect("package stage", pkg.version.includes("v14-3-11-full-regression-docs-closure"));
