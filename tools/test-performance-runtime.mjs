...
expect('current package keeps transition guard regression coverage', pkg.version.includes('v14-1-8-readiness-authority') && viewer.includes('const STAGE = "V14.1.8"') && admin.includes('const STAGE = "V14.1.8"'));
