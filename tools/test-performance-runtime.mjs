...
expect('current package keeps transition guard regression coverage', pkg.version.includes('c6c8c25') && viewer.includes('const STAGE = "C6C8C25.3"') && admin.includes('const STAGE = "C6C8C25.3"'));
