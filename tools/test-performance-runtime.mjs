...
expect('current package keeps transition guard regression coverage', pkg.version.includes('v14-4-7-2-gallery-version-rebase-preservation') && viewer.includes('const STAGE = "V14.1.10.1"') && admin.includes('const STAGE = "V14.1.10.1"'));
...
expect('package identity', pkg.version.includes('v14-4-7-2-gallery-version-rebase-preservation'));
...
expect("package stage", pkg.version.includes("v14-4-7-2-gallery-version-rebase-preservation"));
