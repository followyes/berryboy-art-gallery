...
expect('current package keeps transition guard regression coverage', pkg.version.includes('v14-4-7-4-prepared-storage-delete') && viewer.includes('const STAGE = "V14.1.10.1"') && admin.includes('const STAGE = "V14.1.10.1"'));
...
expect('package identity', pkg.version.includes('v14-4-7-4-prepared-storage-delete'));
...
expect("package stage", pkg.version.includes("v14-4-7-4-prepared-storage-delete"));
