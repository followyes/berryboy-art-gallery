...
import { createExhibitionDataAdapter, resolveInitialPublicRuntime, listPublicExhibitionCards } from "../data/exhibition-api.js?v=v14_3_9_unified_asset_placement";
...
const ENGINE_CACHE_KEY = "v14_3_10_wall_tint_20260916";
...
async function openInlineAdminWorkspace(exhibitionId) {
  ...
  try {
    ...
    if (!inlineAdminModulePromise) inlineAdminModulePromise = import(`./admin-workspace-bootstrap.js?v=v14_3_10_wall_tint`);
