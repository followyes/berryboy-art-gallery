...
import { createExhibitionDataAdapter, resolveInitialPublicRuntime, listPublicExhibitionCards } from "../data/exhibition-api.js?v=v14_4_7_1_modular_frame_rail_layout";
...
async function openInlineAdminWorkspace(exhibitionId) {
  ...
  try {
    ...
    if (!inlineAdminModulePromise) inlineAdminModulePromise = import(`./admin-workspace-bootstrap.js?v=v14_4_7_1_modular_frame_rail_layout`);
