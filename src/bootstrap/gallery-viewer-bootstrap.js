...
import { createExhibitionDataAdapter, resolveInitialPublicRuntime, listPublicExhibitionCards } from "../data/exhibition-api.js?v=v14_4_2_logical_shared_asset_authority";
...
async function openInlineAdminWorkspace(exhibitionId) {
  ...
  try {
    ...
    if (!inlineAdminModulePromise) inlineAdminModulePromise = import(`./admin-workspace-bootstrap.js?v=v14_4_2_logical_shared_asset_authority`);
