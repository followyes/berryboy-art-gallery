...
import { createExhibitionDataAdapter, resolveInitialPublicRuntime, listPublicExhibitionCards } from "../data/exhibition-api.js?v=v14_4_6_unified_exhibition_save";
...
async function openInlineAdminWorkspace(exhibitionId) {
  ...
  try {
    ...
    if (!inlineAdminModulePromise) inlineAdminModulePromise = import(`./admin-workspace-bootstrap.js?v=v14_4_6_unified_exhibition_save`);
