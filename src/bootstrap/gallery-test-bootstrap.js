/* Exhibition Platform — V14.1.9 isolated Test Gallery bootstrap via shared Scene runtime host + canonical readiness authority (V14.1.9 package). */
...
function showError(error) {
  console.error("V14.1.9 Test Gallery:", error);
